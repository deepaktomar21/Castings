                    ...
                    <tbody>
                        ...
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.talents.dataView', $user->id) }}" class="btn btn-primary"><i class="fa fa-eye"></i> View</a>
                                    @if($user->status === 'pending')
                                        <form action="{{ route('admin.talents.verify', $user->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            <button class="btn btn-success">Verify</button>
                                        </form>
                                    @endif
                                    <form action="{{ route('admin.talents.feature', $user->id) }}" method="POST" class="d-inline">
                                        @csrf
